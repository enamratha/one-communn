const processList = [
    {
        ...
        description: `Identify the style that best suits your space and
            personality. From modern minimalism to classic
            elegance, choose what resonates with you.`
    },
    {
        ...
        description: `Choose from a variety of premium materials such
        as rich woods, luxurious fabrics, and robust
        metals to complement your style.`
    },
    {
        ...
        description: `Accurate measurements ensure your furniture
        fits perfectly, maximizing space and
        functionality.`
    },
    {
        ...
        description: `Enjoy seamless delivery and professional
        installation services with every purchase.`
    },
    {
        ...
        description: `Your order is carefully reviewed and processed
        to ensure all details are correct before moving
        to production.`
    },
    
    {
        ...
        description: `Our commitment to quality ensures your
        satisfaction with every piece you choose.`
    },
]
...
const OurProcess = () => (
    <div className="text-center">
        ...
        <ul className="flex justify-between flex-wrap p-5 mx-5">
            {processList.map((process) => (
                <li className="text-left flex justify-center items-center w-6/12 my-3">
                    <div className="w-1/5 m-3">
                        <img className="w-100 " src={process.image} alt={process.title}/>
                    </div>
                    <div className="w-3/5">
